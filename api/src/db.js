...
const videogames_genres = sequelize.define('videogames_genres', {}, { timestamps:false});
const videogames_platforms = sequelize.define('videogames_platforms', {}, {timestamps: false});
